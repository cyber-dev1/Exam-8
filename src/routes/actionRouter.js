...
import { getactions, createaction, updateActionStatus, deleteAction, getactionsByClient , getactionByID } from "../controllers/actionController.js";
...
router.get("/client", getactionsByClient);
